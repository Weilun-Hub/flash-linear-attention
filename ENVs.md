...
| `FLA_INTRACARD_CP`             | unset (`0`) | `0` / `1`  | Opt in to the intra-card context-parallel backend for shared delta-rule state scans. Variable-length inputs only; graph mode falls back. |
